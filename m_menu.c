...
char endmsg[8][89] =
{ // quit messages for doom 1; originally 80 char max, limit raised to accomodate longer strings from latest freedoom commit
	QUITMSG,
#if APPVER_CHEX
...
#else
	"Why would you...",
	"Hey buddy, there's still\nwork to be done.\nAre you sure you want to quit?",
	"Press N to keep\nannihilating aliens.\nPress Y to surrender.",
	"I wouldn't press Y if I were you.\nSocial media is much worse.",
...
char endmsg2[8][89] =
{ // quit messages for doom 2; originally 80 char max, limit raised to accomodate longer strings from latest freedoom commit
	QUITMSG,
#if APPVER_CHEX
	"please don't leave, we\nneed your help!",
	"please don't leave, we\nneed your help!",
