...
void IdentifyVersion (void)
{
	...
	if (M_CheckParm ("-shdev"))
	{
		...
		shareware = true;
		devparm = true;
		D_AddFile (DEVDATA"doom1.wad"); // shareware
#if (APPVER_DOOMREV < AV_DR_DM19U)
...
void D_DoomMain (void)
{
	...
	if (!commercial)
	{
		sprintf (title,
				 ...
				 "                          "
				 "FREEDOOM: Phase 1 (DOS) v%i.%i66"
				 "                          ",
#elif (APPVER_DOOMREV < AV_DR_DM19UP)
				 "                          "
				 "FREEDOOM: Phase 1 (DOS) v%i.%i"
				 "                          ",
#elif (APPVER_DOOMREV < AV_DR_DM19U)
				 "                   "
	...
	else
	{
		sprintf (title,
				 "                         "
#if (APPVER_DOOMREV < AV_DR_DM17)
				 "FREEDOOM: Phase 2 (DOS) v%i.%i66"
				 "                          ",
#elif (APPVER_DOOMREV < AV_DR_DM17A)
				 "FREEDOOM: Phase 2 (DOS) v%i.%i"
				 "                          ",
#elif (APPVER_DOOMREV < AV_DR_DM18FR)
				 "FREEDOOM: Phase 2 (DOS) v%i.%ia"
				 "                          ",
#elif !APPVER_CHEX
				 "FREEDOOM: Phase 2 (DOS) v%i.%i"
				 "                           ",
	...
	if (registered)
	{
		...
		mprintf (
			...
			" source code, which can be found in the gamesrc-ver-recreation repository.\n"
			"===========================================================================\n"
		);
#endif
	}
